...
function setStyles() {
   ...
   */
   ...
   /*
      Next, populate the figure box with preview images of the five fancy style sheets. 
      ...
      the loop do the following:
         ...
         c. Append sheetImg to the figBox element nod.
   */
   for (var i = 0; i < 5; i++) {
      var sheetImg = document.createElement("img");
      sheetImg.setAttribute("src", "na_small_" + i + ".png");
      sheetImg.setAttribute("alt", "na_small_" + i + ".css");
      sheetImg.addEventListener("onsomething")
